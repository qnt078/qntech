<template>
                ...
                <v-window v-model="tab">
                  <v-window-item value="one">
                    <div class="tabItem">
                      ...
                      <v-btn color="secondary" class="text-white"
                        >Find Food</v-btn
                      >
                    </div>
                  </v-window-item>
  ...
  <div class="slide">
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <div class="content">
            <span class="text-gradient">Popular items</span>
          </div>
        </v-col>
        <v-col cols="12">
          <Slide />
  ...
  <div class="poster">
    <div class="content">
      <span>Are you ready to order with the best deals?</span>
      <v-btn color="secondary" class="text-white"
        >Order Now
